...
class Triangle {
    ...
    private double circleOut() {
        double temp = this.a*this.b*this.c;
        temp /= (4*heron());

        return temp*temp*Math.PI;
    }

    @Override
    public String toString() {
        return check() ? String.format("%.3f", circleOut()) : "INVALID";
    }
}

public class J04010_DIỆN_TÍCH_HÌNH_TRÒN_NGOẠI_TIẾP_TAM_GIÁC {
